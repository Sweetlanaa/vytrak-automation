...
// you will just call gerProperty
public class ConfigurationReader {
    ...
    // It is privet because I will be using only in this class
    ...
    static {
        try{
            ...
            // if we do not close file, it will take space from computer memory like Scanner
            file.close();
        }catch (IOException e ){
     ...
     * driver.get(ConfigurationReader.getProperty(keyword));
     */
